---
name: executive-distiller
description: >
  Build a full Minto Pyramid (recursive, N-level) for executive memos and substantial
  documents. Calls writing/rhetoric/argument-structure for sentence-level scaffolding and
  applies MECE checking on every grouping. Use for memo-length executive outputs, board
  materials, or any document where the reader will skim top-down. Returns a hierarchical
